...
if __name__ == '__main__':
    testbed = default_testbed(ip='222.201.187.51', dir_name=dirName, manager_class=GlManager)
    ...
    emu2 = testbed.add_emulator('emulator-2', '222.201.187.52', cpu=128, ram=256, unit='G')
    for i in range(1, 5):
